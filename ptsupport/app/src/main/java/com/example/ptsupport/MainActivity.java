...
public class MainActivity extends FragmentActivity {
    ...
    private int[] images = new int[]{
            R.drawable.p__img00, R.drawable.p__img01, R.drawable.p__img02, R.drawable.p__img03,
            R.drawable.p__img04, R.drawable.p_img05, R.drawable.p_img06, R.drawable.p_img07
    };
